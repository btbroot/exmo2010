...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Adding model 'CommentExmo'
        db.create_table('custom_comments_commentexmo', (
        ...
        if not db.dry_run:
            db.execute("""INSERT INTO custom_comments_commentexmo
             (comment_ptr_id, status) SELECT id, 0 FROM django_comments""", [])
        db.send_create_signal('custom_comments', ['CommentExmo'])
        if not db.dry_run:
    ...
    def backwards(self, orm):
        ...
        db.delete_table('custom_comments_commentexmo')
    ...
    complete_apps = ['comments', 'custom_comments']
