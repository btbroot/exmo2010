...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CommentExmo.posted_by_expert'
        db.add_column(u'custom_comments_commentexmo', 'posted_by_expert',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CommentExmo.posted_by_expert'
        db.delete_column(u'custom_comments_commentexmo', 'posted_by_expert')
    ...
    models = {
        ...
        u'custom_comments.commentexmo': {
            'Meta': {'ordering': "('submit_date',)", 'object_name': 'CommentExmo', '_ormbases': [u'comments.Comment']},
            'answered_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(1, 1, 1, 0, 0)'}),
