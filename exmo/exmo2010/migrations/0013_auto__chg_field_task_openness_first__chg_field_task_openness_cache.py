...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Task.openness_first'
        db.alter_column('exmo2010_task', 'openness_first', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'Task.openness_cache'
        db.alter_column('exmo2010_task', 'openness_cache', self.gf('django.db.models.fields.FloatField')())

    def backwards(self, orm):

        # Changing field 'Task.openness_first'
        db.alter_column('exmo2010_task', 'openness_first', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'Task.openness_cache'
        db.alter_column('exmo2010_task', 'openness_cache', self.gf('django.db.models.fields.FloatField')(null=True))
