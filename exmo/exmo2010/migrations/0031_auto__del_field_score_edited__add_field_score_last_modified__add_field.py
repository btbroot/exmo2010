...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Rename 'Score.edited' field to 'Score.last_modified'
        db.rename_column(u'exmo2010_score', 'edited', 'last_modified')

        # Adding field 'Score.last_modified'
        db.alter_column(u'exmo2010_score', 'last_modified',
                        self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True))

        # Adding field 'Score.editor'
        db.add_column(u'exmo2010_score', 'editor',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Rename 'Score.last_modified' field to 'Score.edited'
        db.rename_column(u'exmo2010_score', 'last_modified', 'edited')

        # Changing field 'Score.edited'
        db.alter_column(u'exmo2010_score', 'edited',
                        self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True))

        # Deleting field 'Score.editor'
        db.delete_column(u'exmo2010_score', 'editor_id')
