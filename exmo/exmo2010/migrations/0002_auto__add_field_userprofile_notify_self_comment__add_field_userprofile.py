...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('exmo2010_userprofile', 'notify_self_comment', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)

        # Adding field 'UserProfile.notify_comment'
        db.add_column('exmo2010_userprofile', 'notify_comment', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)
    ...
    models = {
        ...
        'exmo2010.userprofile': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'notify_comment': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'blank': 'True'}),
            'notify_score_change': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'blank': 'True'}),
            'notify_self_comment': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'blank': 'True'}),
