...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Organization.inv_status'
        db.alter_column('exmo2010_organization', 'inv_status', self.gf('django.db.models.fields.CharField')(max_length=3))

        # Changing field 'InviteOrgs.comment'
        db.alter_column('exmo2010_inviteorgs', 'comment', self.gf('django.db.models.fields.TextField')(default='Test comment'))

        # Changing field 'InviteOrgs.inv_status'
        db.alter_column('exmo2010_inviteorgs', 'inv_status', self.gf('django.db.models.fields.CharField')(max_length=3))

    def backwards(self, orm):

        # Changing field 'Organization.inv_status'
        db.alter_column('exmo2010_organization', 'inv_status', self.gf('django.db.models.fields.CharField')(max_length=3, null=True))

        # Changing field 'InviteOrgs.comment'
        db.alter_column('exmo2010_inviteorgs', 'comment', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'InviteOrgs.inv_status'
        db.alter_column('exmo2010_inviteorgs', 'inv_status', self.gf('django.db.models.fields.CharField')(max_length=3, null=True))
