...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Claim.addressee'
        # На момент создания поля связываем с пользователем с id 1.
        db.add_column('exmo2010_claim', 'addressee',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='addressee', to=orm['auth.User']),
                      keep_default=False)
        # Заполняем `addressee` правильными значениями.
        if not db.dry_run:
            for claim in orm.Claim.objects.all():
                try:
    ...
    def backwards(self, orm):
        # Deleting field 'Claim.addressee'
        db.delete_column('exmo2010_claim', 'addressee_id')
    ...
    models = {
        ...
        'exmo2010.claim': {
            ...
            'addressee': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'addressee'", 'to': "orm['auth.User']"}),
