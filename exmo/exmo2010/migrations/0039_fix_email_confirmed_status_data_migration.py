...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        """
        If user is inactive expert 'email_confirmed' flag should be True.
        In other case 'email_confirmed' flag should equals user's 'is_active' flag.
        """
        orm['exmo2010.UserProfile'].objects.exclude(user__groups__name__in=['expertsA', 'expertsB'])\
