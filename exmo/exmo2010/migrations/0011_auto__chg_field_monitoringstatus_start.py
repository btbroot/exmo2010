...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MonitoringStatus.start'
        db.alter_column('exmo2010_monitoringstatus', 'start', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):

        # Changing field 'MonitoringStatus.start'
        db.alter_column('exmo2010_monitoringstatus', 'start', self.gf('django.db.models.fields.DateTimeField')(null=True))
