...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.show_score_rev1'
        db.add_column(u'exmo2010_userprofile', 'show_score_rev1',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.show_score_rev1'
        db.delete_column(u'exmo2010_userprofile', 'show_score_rev1')
