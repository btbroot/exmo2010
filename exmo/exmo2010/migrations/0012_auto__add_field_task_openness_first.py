...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'Task', fields ['openness_cache']
        db.create_index('exmo2010_task', ['openness_cache'])


    def backwards(self, orm):
        # Removing index on 'Task', fields ['openness_cache']
        db.delete_index('exmo2010_task', ['openness_cache'])
    ...
    models = {
        ...
        'exmo2010.task': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'openness_cache': ('django.db.models.fields.FloatField', [], {'default': '-1', 'null': 'True', 'db_index': 'True', 'blank': 'True'}),
            'openness_first': ('django.db.models.fields.FloatField', [], {'default': '-1', 'null': 'True', 'blank': 'True'}),
