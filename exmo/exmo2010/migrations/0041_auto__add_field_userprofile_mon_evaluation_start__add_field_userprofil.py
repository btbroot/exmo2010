...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.mon_evaluation_start'
        db.add_column(u'exmo2010_userprofile', 'mon_evaluation_start',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'UserProfile.mon_interact_start'
        db.add_column(u'exmo2010_userprofile', 'mon_interact_start',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'UserProfile.mon_interact_end'
        db.add_column(u'exmo2010_userprofile', 'mon_interact_end',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'UserProfile.mon_publish_date'
        db.add_column(u'exmo2010_userprofile', 'mon_publish_date',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.mon_evaluation_start'
        db.delete_column(u'exmo2010_userprofile', 'mon_evaluation_start')

        # Deleting field 'UserProfile.mon_interact_start'
        db.delete_column(u'exmo2010_userprofile', 'mon_interact_start')

        # Deleting field 'UserProfile.mon_interact_end'
        db.delete_column(u'exmo2010_userprofile', 'mon_interact_end')

        # Deleting field 'UserProfile.mon_publish_date'
        db.delete_column(u'exmo2010_userprofile', 'mon_publish_date')
