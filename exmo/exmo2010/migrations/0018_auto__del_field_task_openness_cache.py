...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Task.openness_cache'
        db.delete_column('exmo2010_task', 'openness_cache')


    def backwards(self, orm):
        # Adding field 'Task.openness_cache'
        db.add_column('exmo2010_task', 'openness_cache',
                      self.gf('django.db.models.fields.FloatField')(default=-1, db_index=True),
                      keep_default=False)
