...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Score.edited'
        db.add_column('exmo2010_score', 'edited',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Score.revision'
        db.add_column('exmo2010_score', 'revision',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Score.created'
        db.delete_column('exmo2010_score', 'created')

        # Deleting field 'Score.edited'
        db.delete_column('exmo2010_score', 'edited')

        # Deleting field 'Score.revision'
        db.delete_column('exmo2010_score', 'revision')
