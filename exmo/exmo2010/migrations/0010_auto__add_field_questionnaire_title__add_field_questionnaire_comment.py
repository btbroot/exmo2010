...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Questionnaire.title'
        db.add_column('exmo2010_questionnaire', 'title',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=300, blank=True),
                      keep_default=False)

        # Adding field 'Questionnaire.comment'
        db.add_column('exmo2010_questionnaire', 'comment',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=600, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Questionnaire.title'
        db.delete_column('exmo2010_questionnaire', 'title')

        # Deleting field 'Questionnaire.comment'
        db.delete_column('exmo2010_questionnaire', 'comment')
