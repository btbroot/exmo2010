...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('exmo2010_organization', 'email',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Organization.phone'
        db.add_column('exmo2010_organization', 'phone',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('exmo2010_organization', 'email')

        # Deleting field 'Organization.phone'
        db.delete_column('exmo2010_organization', 'phone')
