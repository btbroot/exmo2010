...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Organization.inv_code'
        db.add_column('exmo2010_organization', 'inv_code',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=6, blank=True),
                      keep_default=False)

        # Adding field 'UserProfile.subscribe'
        db.add_column('exmo2010_userprofile', 'subscribe',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'UserProfile.position'
        db.add_column('exmo2010_userprofile', 'position',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=48, blank=True),
                      keep_default=False)

        # Adding field 'UserProfile.phone'
        db.add_column('exmo2010_userprofile', 'phone',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('exmo2010_organization', 'inv_code')

        # Deleting field 'UserProfile.subscribe'
        db.delete_column('exmo2010_userprofile', 'subscribe')

        # Deleting field 'UserProfile.position'
        db.delete_column('exmo2010_userprofile', 'position')

        # Deleting field 'UserProfile.phone'
        db.delete_column('exmo2010_userprofile', 'phone')


        # Changing field 'UserProfile.preference'
        db.alter_column('exmo2010_userprofile', 'preference', self.gf('django.db.models.fields.TextField')(null=True))
    ...
    models = {
        ...
        'exmo2010.organization': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'inv_code': ('django.db.models.fields.CharField', [], {'max_length': '6', 'blank': 'True'}),
        ...
        'exmo2010.task': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'openness_cache': ('django.db.models.fields.FloatField', [], {'default': '-1', 'db_index': 'True'}),
