...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Organization.recommendations_hidden'
        db.add_column(u'exmo2010_organization', 'recommendations_hidden',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Organization.recommendations_hidden'
        db.delete_column(u'exmo2010_organization', 'recommendations_hidden')
