...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ObserversGroup'
        db.create_table(u'exmo2010_observersgroup', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('monitoring', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['exmo2010.Monitoring'])),
        ))
        db.send_create_signal('exmo2010', ['ObserversGroup'])

        # Adding M2M table for field organizations on 'ObserversGroup'
        db.create_table(u'exmo2010_observersgroup_organizations', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('observersgroup', models.ForeignKey(orm['exmo2010.observersgroup'], null=False)),
            ('organization', models.ForeignKey(orm['exmo2010.organization'], null=False))
        ))
        db.create_unique(u'exmo2010_observersgroup_organizations', ['observersgroup_id', 'organization_id'])

        # Adding M2M table for field users on 'ObserversGroup'
        db.create_table(u'exmo2010_observersgroup_users', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('observersgroup', models.ForeignKey(orm['exmo2010.observersgroup'], null=False)),
            ('user', models.ForeignKey(orm[u'auth.user'], null=False))
        ))
        db.create_unique(u'exmo2010_observersgroup_users', ['observersgroup_id', 'user_id'])


    def backwards(self, orm):
        # Deleting model 'ObserversGroup'
        db.delete_table(u'exmo2010_observersgroup')

        # Removing M2M table for field organizations on 'ObserversGroup'
        db.delete_table('exmo2010_observersgroup_organizations')

        # Removing M2M table for field users on 'ObserversGroup'
        db.delete_table('exmo2010_observersgroup_users')
    ...
    models = {
        ...
        'exmo2010.userprofile': {
            ...
            'show_score_rev1': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
