...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('exmo2010_userprofile', 'preference', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Changing field 'Claim.open_date'
        db.alter_column('exmo2010_claim', 'open_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Claim.open_date'
        db.alter_column('exmo2010_claim', 'open_date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True))
    ...
    models = {
        ...
        'exmo2010.userprofile': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'notify_comment': ('django.db.models.fields.BooleanField', [], {'default': 'True', 'blank': 'True'}),
            'notify_score_change': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'blank': 'True'}),
            'notify_self_comment': ('django.db.models.fields.BooleanField', [], {'default': 'True', 'blank': 'True'}),
