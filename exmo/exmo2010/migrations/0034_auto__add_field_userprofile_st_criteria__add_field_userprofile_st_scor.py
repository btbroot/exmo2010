...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.st_criteria'
        db.add_column(u'exmo2010_userprofile', 'st_criteria',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'UserProfile.st_score'
        db.add_column(u'exmo2010_userprofile', 'st_score',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'UserProfile.st_difference'
        db.add_column(u'exmo2010_userprofile', 'st_difference',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'UserProfile.st_weight'
        db.add_column(u'exmo2010_userprofile', 'st_weight',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'UserProfile.st_type'
        db.add_column(u'exmo2010_userprofile', 'st_type',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.st_criteria'
        db.delete_column(u'exmo2010_userprofile', 'st_criteria')

        # Deleting field 'UserProfile.st_score'
        db.delete_column(u'exmo2010_userprofile', 'st_score')

        # Deleting field 'UserProfile.st_difference'
        db.delete_column(u'exmo2010_userprofile', 'st_difference')

        # Deleting field 'UserProfile.st_weight'
        db.delete_column(u'exmo2010_userprofile', 'st_weight')

        # Deleting field 'UserProfile.st_type'
        db.delete_column(u'exmo2010_userprofile', 'st_type')
