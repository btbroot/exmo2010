...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Monitoring.time_to_answer'
        db.add_column('exmo2010_monitoring', 'time_to_answer',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=3),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Monitoring.time_to_answer'
        db.delete_column('exmo2010_monitoring', 'time_to_answer')
