...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Organization.name_az'
        db.add_column('exmo2010_organization', 'name_az',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Monitoring.name_az'
        db.add_column('exmo2010_monitoring', 'name_az',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Parameter.name_az'
        db.add_column('exmo2010_parameter', 'name_az',
                      self.gf('django.db.models.fields.CharField')(max_length=1000, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Parameter.description_az'
        db.add_column('exmo2010_parameter', 'description_az',
                      self.gf('ckeditor.fields.RichTextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'StaticPage.description_az'
        db.add_column('exmo2010_staticpage', 'description_az',
                      self.gf('django.db.models.fields.TextField')(default='', null=True, blank=True),
                      keep_default=False)

        # Adding field 'StaticPage.content_az'
        db.add_column('exmo2010_staticpage', 'content_az',
                      self.gf('ckeditor.fields.RichTextField')(default='', null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Organization.name_az'
        db.delete_column('exmo2010_organization', 'name_az')

        # Deleting field 'Monitoring.name_az'
        db.delete_column('exmo2010_monitoring', 'name_az')

        # Deleting field 'Parameter.name_az'
        db.delete_column('exmo2010_parameter', 'name_az')

        # Deleting field 'Parameter.description_az'
        db.delete_column('exmo2010_parameter', 'description_az')

        # Deleting field 'StaticPage.description_az'
        db.delete_column('exmo2010_staticpage', 'description_az')

        # Deleting field 'StaticPage.content_az'
        db.delete_column('exmo2010_staticpage', 'content_az')
