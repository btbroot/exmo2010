...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Score.documentComment'
        db.delete_column('exmo2010_score', 'documentComment')

        # Deleting field 'Score.topicalComment'
        db.delete_column('exmo2010_score', 'topicalComment')

        # Deleting field 'Score.hypertextComment'
        db.delete_column('exmo2010_score', 'hypertextComment')

        # Deleting field 'Score.accessibleComment'
        db.delete_column('exmo2010_score', 'accessibleComment')

        # Deleting field 'Score.imageComment'
        db.delete_column('exmo2010_score', 'imageComment')

        # Deleting field 'Score.completeComment'
        db.delete_column('exmo2010_score', 'completeComment')

        # Rename 'Score.foundComment' field to 'Score.links'
        db.rename_column('exmo2010_score', 'foundComment', 'links')


    def backwards(self, orm):
        # Rename 'Score.links' field to 'Score.foundComment'
        db.rename_column('exmo2010_score', 'links', 'foundComment')

        # Adding field 'Score.topicalComment'
        db.add_column('exmo2010_score', 'topicalComment',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Score.hypertextComment'
        db.add_column('exmo2010_score', 'hypertextComment',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Score.accessibleComment'
        db.add_column('exmo2010_score', 'accessibleComment',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Score.imageComment'
        db.add_column('exmo2010_score', 'imageComment',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Score.completeComment'
        db.add_column('exmo2010_score', 'completeComment',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)
