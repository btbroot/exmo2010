...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.rt_representatives'
        db.add_column('exmo2010_userprofile', 'rt_representatives',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'UserProfile.rt_comment_quantity'
        db.add_column('exmo2010_userprofile', 'rt_comment_quantity',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'UserProfile.rt_initial_openness'
        db.add_column('exmo2010_userprofile', 'rt_initial_openness',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'UserProfile.rt_final_openness'
        db.add_column('exmo2010_userprofile', 'rt_final_openness',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'UserProfile.rt_difference'
        db.add_column('exmo2010_userprofile', 'rt_difference',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.rt_representatives'
        db.delete_column('exmo2010_userprofile', 'rt_representatives')

        # Deleting field 'UserProfile.rt_comment_quantity'
        db.delete_column('exmo2010_userprofile', 'rt_comment_quantity')

        # Deleting field 'UserProfile.rt_initial_openness'
        db.delete_column('exmo2010_userprofile', 'rt_initial_openness')

        # Deleting field 'UserProfile.rt_final_openness'
        db.delete_column('exmo2010_userprofile', 'rt_final_openness')

        # Deleting field 'UserProfile.rt_difference'
        db.delete_column('exmo2010_userprofile', 'rt_difference')
    ...
    models = {
        ...
        'exmo2010.userprofile': {
            ...
            'rt_initial_openness': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
