...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.rt_initial_recomm'
        db.add_column(u'exmo2010_userprofile', 'rt_initial_recomm',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'UserProfile.rt_done_recomm'
        db.add_column(u'exmo2010_userprofile', 'rt_done_recomm',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.rt_initial_recomm'
        db.delete_column(u'exmo2010_userprofile', 'rt_initial_recomm')

        # Deleting field 'UserProfile.rt_done_recomm'
        db.delete_column(u'exmo2010_userprofile', 'rt_done_recomm')
    ...
    models = {
        ...
        'exmo2010.feedbackitem': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'scanned_image': ('django.db.models.fields.files.ImageField', [], {'max_length': '100'}),
