...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'InviteOrgs'
        db.create_table('exmo2010_inviteorgs', (
            ...
            ('inv_status', self.gf('django.db.models.fields.CharField')(default='ALL', max_length=3, null=True, blank=True)),
        ))
        db.send_create_signal('exmo2010', ['InviteOrgs'])


    def backwards(self, orm):
        # Deleting model 'InviteOrgs'
        db.delete_table('exmo2010_inviteorgs')
    ...
    models = {
        ...
        'exmo2010.inviteorgs': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'inv_status': ('django.db.models.fields.CharField', [], {'default': "'ALL'", 'max_length': '3', 'null': 'True', 'blank': 'True'}),
        ...
        'exmo2010.organization': {
            ...
            'inv_status': ('django.db.models.fields.CharField', [], {'default': "'NTS'", 'max_length': '3', 'null': 'True', 'blank': 'True'}),
            'monitoring': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['exmo2010.Monitoring']"}),
