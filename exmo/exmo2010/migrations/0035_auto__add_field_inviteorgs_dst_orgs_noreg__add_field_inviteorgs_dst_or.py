...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'InviteOrgs.dst_orgs_noreg'
        db.add_column(u'exmo2010_inviteorgs', 'dst_orgs_noreg',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'InviteOrgs.dst_orgs_inact'
        db.add_column(u'exmo2010_inviteorgs', 'dst_orgs_inact',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'InviteOrgs.dst_orgs_activ'
        db.add_column(u'exmo2010_inviteorgs', 'dst_orgs_activ',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'InviteOrgs.dst_orgusers_inact'
        db.add_column(u'exmo2010_inviteorgs', 'dst_orgusers_inact',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'InviteOrgs.dst_orgusers_activ'
        db.add_column(u'exmo2010_inviteorgs', 'dst_orgusers_activ',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'InviteOrgs.dst_orgs_noreg'
        db.delete_column(u'exmo2010_inviteorgs', 'dst_orgs_noreg')

        # Deleting field 'InviteOrgs.dst_orgs_inact'
        db.delete_column(u'exmo2010_inviteorgs', 'dst_orgs_inact')

        # Deleting field 'InviteOrgs.dst_orgs_activ'
        db.delete_column(u'exmo2010_inviteorgs', 'dst_orgs_activ')

        # Deleting field 'InviteOrgs.dst_orgusers_inact'
        db.delete_column(u'exmo2010_inviteorgs', 'dst_orgusers_inact')

        # Deleting field 'InviteOrgs.dst_orgusers_activ'
        db.delete_column(u'exmo2010_inviteorgs', 'dst_orgusers_activ')
