...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'UserProfile.preference'
        db.delete_column('exmo2010_userprofile', 'preference')

        # Adding field 'UserProfile.notification_type'
        db.add_column('exmo2010_userprofile', 'notification_type',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'UserProfile.notification_interval'
        db.add_column('exmo2010_userprofile', 'notification_interval',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=1),
                      keep_default=False)

        # Adding field 'UserProfile.notification_self'
        db.add_column('exmo2010_userprofile', 'notification_self',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'UserProfile.digest_date_journal'
        db.add_column('exmo2010_userprofile', 'digest_date_journal',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'UserProfile.preference'
        db.add_column('exmo2010_userprofile', 'preference',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Deleting field 'UserProfile.notification_type'
        db.delete_column('exmo2010_userprofile', 'notification_type')

        # Deleting field 'UserProfile.notification_interval'
        db.delete_column('exmo2010_userprofile', 'notification_interval')

        # Deleting field 'UserProfile.notification_self'
        db.delete_column('exmo2010_userprofile', 'notification_self')

        # Deleting field 'UserProfile.digest_date_journal'
        db.delete_column('exmo2010_userprofile', 'digest_date_journal')
