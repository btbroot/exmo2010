...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('exmo2010_monitoring', 'publish_date', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2014, 2, 18, 0, 0)))

        # Changing field 'Monitoring.interact_date'
        db.alter_column('exmo2010_monitoring', 'interact_date', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2014, 2, 18, 0, 0)))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Monitoring.publish_date'
        db.alter_column('exmo2010_monitoring', 'publish_date', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'Monitoring.interact_date'
        db.alter_column('exmo2010_monitoring', 'interact_date', self.gf('django.db.models.fields.DateField')(null=True))
