...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Score.accomplished'
        db.add_column(u'exmo2010_score', 'accomplished',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Score.accomplished'
        db.delete_column(u'exmo2010_score', 'accomplished')
