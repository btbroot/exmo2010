...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SentMailHistory.dst_orgusers_unseen'
        db.add_column(u'exmo2010_sentmailhistory', 'dst_orgusers_unseen',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SentMailHistory.dst_orgusers_unseen'
        db.delete_column(u'exmo2010_sentmailhistory', 'dst_orgusers_unseen')
