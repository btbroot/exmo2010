...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'exmo2010_frontpagetextfragments', (
            ...
            ('content', self.gf('ckeditor.fields.RichTextField')(default='', blank=True)),
            ('content_ru', self.gf('ckeditor.fields.RichTextField')(default='', null=True, blank=True)),
            ('content_en', self.gf('ckeditor.fields.RichTextField')(default='', null=True, blank=True)),
            ('content_ka', self.gf('ckeditor.fields.RichTextField')(default='', null=True, blank=True)),
            ('content_az', self.gf('ckeditor.fields.RichTextField')(default='', null=True, blank=True)),
        ))
