...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'FrontPageTextFragments'
        db.create_table(u'exmo2010_frontpagetextfragments', (
            ...
            ('content_ru', self.gf('django.db.models.fields.TextField')(default='', null=True, blank=True)),
            ('content_en', self.gf('django.db.models.fields.TextField')(default='', null=True, blank=True)),
            ('content_ka', self.gf('django.db.models.fields.TextField')(default='', null=True, blank=True)),
            ('content_az', self.gf('django.db.models.fields.TextField')(default='', null=True, blank=True)),
        ))
        db.send_create_signal('exmo2010', ['FrontPageTextFragments'])


    def backwards(self, orm):
        # Deleting model 'FrontPageTextFragments'
        db.delete_table(u'exmo2010_frontpagetextfragments')
    ...
    models = {
        ...
        'exmo2010.frontpagetextfragments': {
            ...
            'content_az': ('django.db.models.fields.TextField', [], {'default': "''", 'null': 'True', 'blank': 'True'}),
            'content_en': ('django.db.models.fields.TextField', [], {'default': "''", 'null': 'True', 'blank': 'True'}),
            'content_ka': ('django.db.models.fields.TextField', [], {'default': "''", 'null': 'True', 'blank': 'True'}),
