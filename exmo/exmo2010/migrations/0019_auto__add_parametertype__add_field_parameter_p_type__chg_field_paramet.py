...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('exmo2010_parametertype', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=100, db_index=True)),
            ('monitoring', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['exmo2010.Monitoring'], null=True, blank=True)),
            ('parent', self.gf('mptt.fields.TreeForeignKey')(blank=True, related_name='children', null=True, to=orm['exmo2010.ParameterType'])),
            ('lft', self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True)),
            ('rght', self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True)),
            ('tree_id', self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True)),
            ('level', self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True)),
        ))
        db.send_create_signal('exmo2010', ['ParameterType'])

        # Adding field 'Parameter.p_type'
        db.add_column('exmo2010_parameter', 'p_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['exmo2010.ParameterType'], null=True, blank=True),
                      keep_default=False)


        # Changing field 'Parameter.description'
        db.alter_column('exmo2010_parameter', 'description', self.gf('django.db.models.fields.TextField')(default=''))

        # Changing field 'Parameter.keywords'
        db.alter_column('exmo2010_parameter', 'keywords', self.gf('exmo2010.fields.TagField')(default=''))

    def backwards(self, orm):
        # Deleting model 'ParameterType'
        db.delete_table('exmo2010_parametertype')

        # Deleting field 'Parameter.p_type'
        db.delete_column('exmo2010_parameter', 'p_type_id')


        # Changing field 'Parameter.description'
        db.alter_column('exmo2010_parameter', 'description', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Parameter.keywords'
        db.alter_column('exmo2010_parameter', 'keywords', self.gf('exmo2010.fields.TagField')(null=True))
    ...
    models = {
        ...
        'exmo2010.monitoringinteractactivity': {
            'Meta': {'object_name': 'MonitoringInteractActivity'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'exmo2010.parameter': {
            ...
            'p_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['exmo2010.ParameterType']", 'null': 'True', 'blank': 'True'}),
            'topical': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'weight': ('django.db.models.fields.IntegerField', [], {})
        },
        'exmo2010.parametertype': {
            'Meta': {'object_name': 'ParameterType'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'level': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'lft': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'monitoring': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['exmo2010.Monitoring']", 'null': 'True', 'blank': 'True'}),
            'parent': ('mptt.fields.TreeForeignKey', [], {'blank': 'True', 'related_name': "'children'", 'null': 'True', 'to': "orm['exmo2010.ParameterType']"}),
