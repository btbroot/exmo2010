...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('exmo2010_userprofile', 'sex',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('exmo2010_userprofile', 'sex')
    ...
    models = {
        ...
        'exmo2010.score': {
            'Meta': {'ordering': "('task__user__username', 'task__organization__name', 'parameter__code')", 'unique_together': "(('task', 'parameter'),)", 'object_name': 'Score'},
