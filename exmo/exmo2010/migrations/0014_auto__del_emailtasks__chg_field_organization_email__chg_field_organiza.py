...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'EmailTasks'
        db.delete_table('exmo2010_emailtasks')


        # Changing field 'Organization.email'
        db.alter_column('exmo2010_organization', 'email', self.gf('exmo2010.models.organization.EmailsField')(null=True))

        # Changing field 'Organization.phone'
        db.alter_column('exmo2010_organization', 'phone', self.gf('exmo2010.models.organization.PhonesField')(null=True))

    def backwards(self, orm):
        # Adding model 'EmailTasks'
        db.create_table('exmo2010_emailtasks', (
            ('organization', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['exmo2010.Organization'])),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('task_id', self.gf('django.db.models.fields.CharField')(max_length=60, db_index=True)),
        ))
        db.send_create_signal('exmo2010', ['EmailTasks'])
