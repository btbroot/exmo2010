...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'MonitoringStatus', fields ['start']
        db.create_index('exmo2010_monitoringstatus', ['start'])


    def backwards(self, orm):
        # Removing index on 'MonitoringStatus', fields ['start']
        db.delete_index('exmo2010_monitoringstatus', ['start'])
