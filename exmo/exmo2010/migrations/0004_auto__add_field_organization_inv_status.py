...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Organization.inv_status'
        db.add_column('exmo2010_organization', 'inv_status',
                      self.gf('django.db.models.fields.CharField')(default='NTS', max_length=3, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Organization.inv_status'
        db.delete_column('exmo2010_organization', 'inv_status')
