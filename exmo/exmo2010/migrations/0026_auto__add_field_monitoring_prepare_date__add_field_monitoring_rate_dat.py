...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Monitoring.rate_date'
        db.add_column('exmo2010_monitoring', 'rate_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Monitoring.revision_date'
        db.add_column('exmo2010_monitoring', 'revision_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Monitoring.interact_date'
        db.add_column('exmo2010_monitoring', 'interact_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)
        ...
        # Adding field 'Monitoring.publish_date'
        db.add_column('exmo2010_monitoring', 'publish_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Monitoring.finishing_date'
        db.add_column('exmo2010_monitoring', 'finishing_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Monitoring.rate_date'
        db.delete_column('exmo2010_monitoring', 'rate_date')

        # Deleting field 'Monitoring.revision_date'
        db.delete_column('exmo2010_monitoring', 'revision_date')

        # Deleting field 'Monitoring.interact_date'
        db.delete_column('exmo2010_monitoring', 'interact_date')

        # Deleting field 'Monitoring.result_date'
        db.delete_column('exmo2010_monitoring', 'result_date')

        # Deleting field 'Monitoring.publish_date'
        db.delete_column('exmo2010_monitoring', 'publish_date')

        # Deleting field 'Monitoring.finishing_date'
        db.delete_column('exmo2010_monitoring', 'finishing_date')
