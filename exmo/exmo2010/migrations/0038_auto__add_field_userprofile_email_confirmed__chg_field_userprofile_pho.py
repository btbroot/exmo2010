...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'exmo2010_userprofile', 'email_confirmed',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


        # Changing field 'UserProfile.phone'
        db.alter_column(u'exmo2010_userprofile', 'phone', self.gf('django.db.models.fields.CharField')(max_length=30, null=True))

        # Changing field 'UserProfile.position'
        db.alter_column(u'exmo2010_userprofile', 'position', self.gf('django.db.models.fields.CharField')(max_length=48, null=True))

    def backwards(self, orm):
        # Deleting field 'UserProfile.email_confirmed'
        db.delete_column(u'exmo2010_userprofile', 'email_confirmed')


        # Changing field 'UserProfile.phone'
        db.alter_column(u'exmo2010_userprofile', 'phone', self.gf('django.db.models.fields.CharField')(default='', max_length=30))

        # Changing field 'UserProfile.position'
        db.alter_column(u'exmo2010_userprofile', 'position', self.gf('django.db.models.fields.CharField')(default='', max_length=48))
