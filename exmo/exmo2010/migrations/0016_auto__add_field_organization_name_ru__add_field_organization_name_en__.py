...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Organization.name_ru'
        db.add_column('exmo2010_organization', 'name_ru',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Organization.name_en'
        db.add_column('exmo2010_organization', 'name_en',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Organization.name_ka'
        db.add_column('exmo2010_organization', 'name_ka',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Monitoring.name_ru'
        db.add_column('exmo2010_monitoring', 'name_ru',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Monitoring.name_en'
        db.add_column('exmo2010_monitoring', 'name_en',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Monitoring.name_ka'
        db.add_column('exmo2010_monitoring', 'name_ka',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Parameter.name_ru'
        db.add_column('exmo2010_parameter', 'name_ru',
                      self.gf('django.db.models.fields.CharField')(max_length=1000, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Parameter.name_en'
        db.add_column('exmo2010_parameter', 'name_en',
                      self.gf('django.db.models.fields.CharField')(max_length=1000, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Parameter.name_ka'
        db.add_column('exmo2010_parameter', 'name_ka',
                      self.gf('django.db.models.fields.CharField')(max_length=1000, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Parameter.description_ru'
        db.add_column('exmo2010_parameter', 'description_ru',
                      self.gf('ckeditor.fields.RichTextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Parameter.description_en'
        db.add_column('exmo2010_parameter', 'description_en',
                      self.gf('ckeditor.fields.RichTextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Parameter.description_ka'
        db.add_column('exmo2010_parameter', 'description_ka',
                      self.gf('ckeditor.fields.RichTextField')(null=True, blank=True),
                      keep_default=False)


        # Changing field 'Parameter.description'
        db.alter_column('exmo2010_parameter', 'description', self.gf('ckeditor.fields.RichTextField')())

    def backwards(self, orm):
        # Deleting field 'Organization.name_ru'
        db.delete_column('exmo2010_organization', 'name_ru')

        # Deleting field 'Organization.name_en'
        db.delete_column('exmo2010_organization', 'name_en')

        # Deleting field 'Organization.name_ka'
        db.delete_column('exmo2010_organization', 'name_ka')

        # Deleting field 'Monitoring.name_ru'
        db.delete_column('exmo2010_monitoring', 'name_ru')

        # Deleting field 'Monitoring.name_en'
        db.delete_column('exmo2010_monitoring', 'name_en')

        # Deleting field 'Monitoring.name_ka'
        db.delete_column('exmo2010_monitoring', 'name_ka')

        # Deleting field 'Parameter.name_ru'
        db.delete_column('exmo2010_parameter', 'name_ru')

        # Deleting field 'Parameter.name_en'
        db.delete_column('exmo2010_parameter', 'name_en')

        # Deleting field 'Parameter.name_ka'
        db.delete_column('exmo2010_parameter', 'name_ka')

        # Deleting field 'Parameter.description_ru'
        db.delete_column('exmo2010_parameter', 'description_ru')

        # Deleting field 'Parameter.description_en'
        db.delete_column('exmo2010_parameter', 'description_en')

        # Deleting field 'Parameter.description_ka'
        db.delete_column('exmo2010_parameter', 'description_ka')


        # Changing field 'Parameter.description'
        db.alter_column('exmo2010_parameter', 'description', self.gf('django.db.models.fields.TextField')())
