...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Parameter.name'
        db.alter_column('exmo2010_parameter', 'name', self.gf('django.db.models.fields.CharField')(max_length=1000))
    
    
    def backwards(self, orm):
        
        # Changing field 'Parameter.name'
        db.alter_column('exmo2010_parameter', 'name', self.gf('django.db.models.fields.CharField')(max_length=255))
