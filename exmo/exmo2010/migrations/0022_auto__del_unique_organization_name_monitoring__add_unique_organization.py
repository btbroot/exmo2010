...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        #Adding unique constraint on 'Organization', fields ['name_ru', 'monitoring']
        db.create_unique('exmo2010_organization', ['name_ru', 'monitoring_id'])

        # Adding unique constraint on 'Organization', fields ['name_ka', 'monitoring']
        db.create_unique('exmo2010_organization', ['name_ka', 'monitoring_id'])

        # Adding unique constraint on 'Organization', fields ['name_az', 'monitoring']
        db.create_unique('exmo2010_organization', ['name_az', 'monitoring_id'])

        # Adding unique constraint on 'Organization', fields ['name_en', 'monitoring']
        db.create_unique('exmo2010_organization', ['name_en', 'monitoring_id'])

        # Adding unique constraint on 'Parameter', fields ['name_ru', 'monitoring']
        db.create_unique('exmo2010_parameter', ['name_ru', 'monitoring_id'])

        # Adding unique constraint on 'Parameter', fields ['name_ka', 'monitoring']
        db.create_unique('exmo2010_parameter', ['name_ka', 'monitoring_id'])

        # Adding unique constraint on 'Parameter', fields ['name_az', 'monitoring']
        db.create_unique('exmo2010_parameter', ['name_az', 'monitoring_id'])

        # Adding unique constraint on 'Parameter', fields ['name_en', 'monitoring']
        db.create_unique('exmo2010_parameter', ['name_en', 'monitoring_id'])

    def backwards(self, orm):
        # Removing unique constraint on 'Parameter', fields ['name_en', 'monitoring']
        db.delete_unique('exmo2010_parameter', ['name_en', 'monitoring_id'])

        # Removing unique constraint on 'Parameter', fields ['name_az', 'monitoring']
        db.delete_unique('exmo2010_parameter', ['name_az', 'monitoring_id'])

        # Removing unique constraint on 'Parameter', fields ['name_ka', 'monitoring']
        db.delete_unique('exmo2010_parameter', ['name_ka', 'monitoring_id'])

        # Removing unique constraint on 'Parameter', fields ['name_ru', 'monitoring']
        db.delete_unique('exmo2010_parameter', ['name_ru', 'monitoring_id'])

        # Removing unique constraint on 'Organization', fields ['name_en', 'monitoring']
        db.delete_unique('exmo2010_organization', ['name_en', 'monitoring_id'])

        # Removing unique constraint on 'Organization', fields ['name_az', 'monitoring']
        db.delete_unique('exmo2010_organization', ['name_az', 'monitoring_id'])

        # Removing unique constraint on 'Organization', fields ['name_ka', 'monitoring']
        db.delete_unique('exmo2010_organization', ['name_ka', 'monitoring_id'])

        # Removing unique constraint on 'Organization', fields ['name_ru', 'monitoring']
        db.delete_unique('exmo2010_organization', ['name_ru', 'monitoring_id'])
