...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Monitoring.no_interact'
        db.add_column('exmo2010_monitoring', 'no_interact',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Monitoring.no_interact'
        db.delete_column('exmo2010_monitoring', 'no_interact')
