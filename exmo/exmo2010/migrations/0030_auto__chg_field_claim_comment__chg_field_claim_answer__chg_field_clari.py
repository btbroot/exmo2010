...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'exmo2010_claim', 'comment', self.gf('ckeditor.fields.RichTextField')())

        # Changing field 'Claim.answer'
        db.alter_column(u'exmo2010_claim', 'answer', self.gf('ckeditor.fields.RichTextField')())

        # Changing field 'Clarification.comment'
        db.alter_column(u'exmo2010_clarification', 'comment', self.gf('ckeditor.fields.RichTextField')())

        # Changing field 'Clarification.answer'
        db.alter_column(u'exmo2010_clarification', 'answer', self.gf('ckeditor.fields.RichTextField')())

    def backwards(self, orm):

        # Changing field 'Claim.comment'
        db.alter_column(u'exmo2010_claim', 'comment', self.gf('django.db.models.fields.TextField')())

        # Changing field 'Claim.answer'
        db.alter_column(u'exmo2010_claim', 'answer', self.gf('django.db.models.fields.TextField')())

        # Changing field 'Clarification.comment'
        db.alter_column(u'exmo2010_clarification', 'comment', self.gf('django.db.models.fields.TextField')())

        # Changing field 'Clarification.answer'
        db.alter_column(u'exmo2010_clarification', 'answer', self.gf('django.db.models.fields.TextField')())
