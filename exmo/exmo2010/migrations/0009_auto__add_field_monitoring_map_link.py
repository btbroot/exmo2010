...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Monitoring.map_link'
        db.add_column('exmo2010_monitoring', 'map_link',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Monitoring.map_link'
        db.delete_column('exmo2010_monitoring', 'map_link')
