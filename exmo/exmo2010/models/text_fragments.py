...
class FrontPageTextFragments(BaseModel):
    """
    Model for simple text fragments editable by staff.
    FrontPageTextFragments is identified by its name as primary key,
    for example: "about_project_left_cell".

    """
    class Meta(BaseModel.Meta):
        verbose_name = _('Front page text fragment')
        verbose_name_plural = _('Front page text fragments')
